                ...
                <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <input type="number" name="no_of_hours" value="{{ $workhour['no_of_hours'] }}" class="form-control">
                      </div>
                    </div>
                </div>  
                <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                          ...
                          <input type="number" name="hourly_rate" value="{{ $workhour['hourly_rate'] }}" class="form-control">
                      </div>
                    </div>
                </div>   
