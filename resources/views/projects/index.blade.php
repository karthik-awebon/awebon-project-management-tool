                    ...
                    <table class="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="/projects/{{$project['id']}}"><input type="submit" value="Edit" class="btn btn-primary"></a>
                            <a href="/delete-projects/{{ $project['id'] }}"><input type="submit" value="Delete" class="btn btn-primary">
                          </td>
                        </tr>
                        @endforeach  
                      </tbody>
